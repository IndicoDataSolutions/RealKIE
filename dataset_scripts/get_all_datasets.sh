...
#python3.7 dataset_scripts/get_datasets.py --name="fcc_invoices_v2" --dataset_id=12716 --labelset_id=27178 --label_col="FCC Invoices - Dataset Paper" --text_col=document --host=app.indico.io --api_token_path=$api_token_path --update=$update &
